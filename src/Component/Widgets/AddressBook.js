  ...
  return (
    <div className='pt-8'>
        <div className='flex items-start justify-between border-b pb-7 border-b-slate-200'>
            <div>
                <p className='text-lg font-medium text-slate-800'>Address Book</p>
        ...
        <div className={`space-y-8 pt-12 `} >
            ...
            <div className='grid gap-10 md:grid-cols-4'>
                <div>
                    <p className='font-medium text-slate-800'>Your Places</p>
                    ...
                    <div className='grid gap-5 sm:grid-cols-2 lg:grid-cols-3'>
                        <div className='p-5 bg-white rounded'>
                            <div className='flex items-center justify-between'>
                               <div className='flex items-center pr-4'>
                                    <p className='pr-2 font-medium text-slate-800'>HQ</p>
                                    <span className='px-3 py-0.5 text-xs font-medium text-indigo-500 rounded-lg bg-indigo-50'>First</span>
                               </div> 
                               <button>
                        ...
                        <div className='p-5 bg-white rounded'>
                            <div className='flex items-center justify-between'>
                               <div className='flex items-center pr-4'>
                                    <p className='pr-2 font-medium text-slate-800'>HQ</p>
                                    <span className='px-3 py-0.5 text-xs font-medium text-indigo-500 rounded-lg bg-indigo-50'>Second</span>
                               </div> 
                               <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                        ...
                        <div className='p-5 bg-white rounded'>
                            <div className='flex items-center justify-between'>
                               <div className='flex items-center pr-4'>
                                    <p className='pr-2 font-medium text-slate-800'>HQ</p>
                                    <span className='px-3 py-0.5 text-xs font-medium text-indigo-500 rounded-lg bg-indigo-50'>Third</span>
                               </div> 
                               <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                        ...
                        <div className='p-5 bg-white rounded'>
                            <div className='flex items-center justify-between'>
                               <div className='flex items-center pr-4'>
                                    <p className='pr-2 font-medium text-slate-800'>HQ</p>
                                    <span className='px-3 py-0.5 text-xs font-medium text-indigo-500 rounded-lg bg-indigo-50'>Fourth</span>
                               </div> 
                               <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
